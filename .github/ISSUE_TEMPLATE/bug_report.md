...
2. Check out and follow our Guidelines: https://github.com/EndemolShineGroup/generator-serverless-nodejs-ts/blob/develop/CONTRIBUTING.md
...
***Version of `generator-serverless-nodejs-ts` you're using***:
